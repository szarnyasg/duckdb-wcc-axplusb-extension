...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="axplusb" -DDUCKDB_OOT_EXTENSION_AXPLUSB_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_AXPLUSB_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_AXPLUSB_INCLUDE_PATH="$(PROJ_DIR)src/include"
...
format:
	clang-format --sort-includes=0 -style=file -i src/axplusb_extension.cpp
